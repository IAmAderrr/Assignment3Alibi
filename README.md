Perfect — here is a clean, submission-ready `README.md` tailored exactly to your finished project and what you implemented.
...
The schema is executed automatically when application is run using the SchemaRunner utility class. This ensures the required tables exist before any CRUD operations are performed.
